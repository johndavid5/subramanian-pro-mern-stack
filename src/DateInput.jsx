...
export default class DateInput extends React.Component {
  ...
  // For friendly displayable format...
  displayFormat(date){
    return( date != null ) ? date.toDateString() : '';
  }

  // For editable format...for displaying and handling
  ...
  render(){
    ...
    const value = (this.state.focused || !this.state.valid) ? this.state.value : this.displayFormat
